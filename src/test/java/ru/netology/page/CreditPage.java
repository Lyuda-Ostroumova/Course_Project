...
public class CreditPage {
    ...
    private SelenideElement button = $(byText("Продолжить")).parent().$("[type='button']");
    ...
    public void filledInForm(CardInfo cardInfo) {
    ...
    public void paymentSuccessful() {
        paymentSuccessful.shouldBe(Condition.visible, Duration.ofSeconds(15));
    }
}